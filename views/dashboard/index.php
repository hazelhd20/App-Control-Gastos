...
<section class="space-y-12">
    ...
    <section class="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
        <a href="/App-Control-Gastos/public/transacciones#registro" class="group flex items-center justify-between rounded-3xl border border-slate-200/70 dark:border-slate-800/70 bg-white/90 dark:bg-slate-900/70 px-5 py-4 shadow-sm hover:-translate-y-1 hover:shadow-floating transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-300">
            <span class="flex items-center gap-3">
                <span class="inline-flex h-11 w-11 items-center justify-center rounded-2xl bg-brand-100 text-brand-600 shadow-inner shadow-white/40">
            ...
            <?= lucide_icon('chevron-right', 'hidden sm:block h-4 w-4 text-slate-300 group-hover:text-brand-400 transition') ?>
        </a>
        <a href="/App-Control-Gastos/public/reportes" class="group flex items-center justify-between rounded-3xl border border-slate-200/70 dark:border-slate-800/70 bg-white/90 dark:bg-slate-900/70 px-5 py-4 shadow-sm hover:-translate-y-1 hover:shadow-floating transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-300">
            <span class="flex items-center gap-3">
                <span class="inline-flex h-11 w-11 items-center justify-center rounded-2xl bg-sky-100 text-brand-600 shadow-inner shadow-white/40">
        ...
        <a href="/App-Control-Gastos/public/perfil#limite" class="group flex items-center justify-between rounded-3xl border border-slate-200/70 dark:border-slate-800/70 bg-white/90 dark:bg-slate-900/70 px-5 py-4 shadow-sm hover:-translate-y-1 hover:shadow-floating transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-300">
            <span class="flex items-center gap-3">
                <span class="inline-flex h-11 w-11 items-center justify-center rounded-2xl bg-emerald-100 text-brand-600 shadow-inner shadow-white/40">
        ...
        <article class="surface-card rounded-3xl border border-slate-200/70 dark:border-slate-800/60 p-6 shadow-soft">
            ...
            <?php if (empty($recent)): ?>
                <div class="flex flex-col items-center justify-center gap-4 rounded-2xl border border-dashed border-slate-300/70 dark:border-slate-700/70 bg-slate-50/60 dark:bg-slate-900/40 px-6 py-10 text-center">
                    ...
                    <a href="/App-Control-Gastos/public/transacciones#registro" class="inline-flex items-center gap-2 rounded-full bg-brand-600 px-4 py-2 text-xs font-semibold text-white shadow hover:bg-brand-700 transition">
                        <?= lucide_icon('plus-circle', 'h-4 w-4') ?>
                        Registrar movimiento
                    </a>
                </div>
