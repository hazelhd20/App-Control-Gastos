...
<section class="space-y-8">
    <header class="space-y-2">
        <h1 class="text-3xl font-semibold text-primary-700">Configura tu perfil financiero</h1>
    ...
    <form action="/App-Control-Gastos/public/perfil/configuracion-inicial" method="POST" class="grid gap-10">
        ...
        <section class="card-glass rounded-3xl p-8 space-y-6">
            <h2 class="text-xl font-semibold text-primary-700">Ingresos y moneda</h2>
        ...
        <section class="card-glass rounded-3xl p-8 space-y-6">
            <h2 class="text-xl font-semibold text-primary-700">Medios de gasto</h2>
        ...
        <section class="card-glass rounded-3xl p-8 space-y-6">
            <div class="flex items-center justify-between gap-4">
                <div>
                    <h2 class="text-xl font-semibold text-primary-700">Objetivo principal</h2>
                ...
                <div class="space-y-4">
                    ...
                    <div data-goal-container="other" class="<?= $oldValue('goal_type') === 'other' ? '' : 'hidden' ?> space-y-2">
                        ...
                        <textarea id="goal_description" name="goal_description" rows="3"
                                  class="w-full rounded-2xl border-slate-200 bg-white focus:border-primary-300 focus:ring focus:ring-primary-100 px-4 py-3"><?= htmlspecialchars($oldValue('goal_description'), ENT_QUOTES, 'UTF-8') ?></textarea>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="card-glass rounded-3xl p-8 space-y-6">
            <h2 class="text-xl font-semibold text-primary-700">Limite mensual de gastos</h2>
